...
{
    // https://github.com/samirahmed/SuperPOCO/blob/master/SuperPoco/EntityConverter.cs
    ...
    public static class EntityConverter
    {
        ...
        public static TOutput ConvertTo<TOutput>(DynamicTableEntity entity)
        {
            ...
            WriteToJObject(jobject, new KeyValuePair<string, EntityProperty>("Timestamp", new EntityProperty(entity.Timestamp)));
